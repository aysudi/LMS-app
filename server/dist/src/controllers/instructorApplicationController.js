...
import { submitInstructorApplication, getAllInstructorApplications, getUserInstructorApplication, approveInstructorApplication, rejectInstructorApplication, } from "../services/instructorApplicationService";
...
export const submitApplication = async (req, res) => {
    try {
        ...
        const application = await submitInstructorApplication(userId, applicationData);
        res.status(201).json({
            success: true,
...
export const approveApplication = async (req, res) => {
    try {
        ...
        const application = await approveInstructorApplication(applicationId, userId, adminFeedback);
        res.status(200).json({
            success: true,
...
export const rejectApplication = async (req, res) => {
    try {
        ...
        const application = await rejectInstructorApplication(applicationId, userId, rejectionReason, adminFeedback);
        res.status(200).json({
            success: true,
