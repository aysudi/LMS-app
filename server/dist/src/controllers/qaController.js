import { createQuestion, getQuestionsByCourse, getQuestionById, updateQuestion, deleteQuestion, voteOnQuestion, createAnswer, updateAnswer, deleteAnswer, voteOnAnswer, acceptAnswer, } from "../services/qaService.js";
...
export const acceptAnswerController = async (req, res) => {
    try {
        const userId = req.user?.id;
