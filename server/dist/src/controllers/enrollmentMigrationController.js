import { performFullEnrollmentSync, syncEnrollmentData, syncFromUserEnrolledCourses, syncFromCourseStudentsEnrolled, } from "../services/enrollmentMigrationService";
// Admin function to sync all enrollment data
export const syncAllEnrollments = async (req, res) => {
    try {
...
export const syncFromEnrollmentModel = async (req, res) => {
    try {
...
export const syncUsersToCoursesOnly = async (req, res) => {
    try {
...
export const syncCoursesToUsersOnly = async (req, res) => {
    try {
