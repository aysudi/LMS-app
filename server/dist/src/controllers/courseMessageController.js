...
export const sendCourseMessage = async (req, res) => {
    try {
        ...
        const populatedMessage = await CourseMessage.findById(message._id).populate("sender", "firstName lastName avatar");
...
export const deleteCourseMessage = async (req, res) => {
    try {
...
// Edit a message
export const editCourseMessage = async (req, res) => {
    try {
        const { messageId } = req.params;
