export const emailTemplates = {
    instructorApplicationReceived: (firstName, lastName) => ({
    ...
    instructorApplicationApproved: (firstName, lastName, adminFeedback) => ({
        subject: "🎉 Congratulations! Your Instructor Application Has Been Approved - Skillify",
        html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    instructorApplicationRejected: (firstName, lastName, rejectionReason, adminFeedback) => ({
