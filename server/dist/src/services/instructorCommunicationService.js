...
export const getInstructorMessagesService = async (instructorId, page, limit, status = "all", type = "all", courseId) => {
...
export const replyToMessageService = async (instructorId, messageId, message) => {
...
export const markMessageAsReadService = async (instructorId, messageId) => {
...
export const markMessageAsResolvedService = async (instructorId, messageId) => {
    const communication = await InstructorCommunication.findOneAndUpdate({
        _id: messageId,
        instructor: instructorId,
    }, {
...
export const getMessageStatsService = async (instructorId) => {
