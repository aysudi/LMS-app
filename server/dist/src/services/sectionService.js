...
export const updateSection = async (sectionId, updateData, instructorId) => {
...
export const deleteSection = async (sectionId, instructorId) => {
    const section = await Section.findById(sectionId).populate("course");
    if (!section) {
        throw new Error("Section not found");
    }
...
export const getSectionsWithLessonCount = async (courseId) => {
