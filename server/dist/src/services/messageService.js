...
export const createMessage = async (messageData) => {
    ...
    try {
        const { senderId, receiverId, courseId, content, messageType = "text", } = messageData;
        ...
        const isStudentToInstructor = senderId !== course.instructor.toString() &&
            receiverId === course.instructor.toString();
        const isInstructorToStudent = senderId === course.instructor.toString() &&
            receiverId !== course.instructor.toString();
        if (!isStudentToInstructor && !isInstructorToStudent) {
            throw new Error("Invalid conversation participants");
        }
        if (isStudentToInstructor && !enrollment) {
            throw new Error("You must be enrolled in this course to message the instructor");
        }
...
export const getConversations = async (query) => {
    try {
        const { findOrCreateConversation, getConversations: getConversationsFromService, } = await import("./conversationService.js");
...
export const getConversationById = async (conversationId, userId) => {
    try {
        const { getConversationById: getConversationByIdFromService } = await import("./conversationService.js");
...
export const deleteConversation = async (conversationId, userId) => {
    try {
        const { deleteConversation: deleteConversationFromService } = await import("./conversationService.js");
