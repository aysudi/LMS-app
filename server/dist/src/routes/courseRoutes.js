...
import { createCourse, deleteCourse, getAllCourses, getCourseById, getInstructorCourses, getUserCourses, updateCourse, } from "../controllers/courseController";
...
courseRouter.post("/", authorizeRoles(UserRole.INSTRUCTOR), (req, res) => createCourse(req, res));
courseRouter.put("/:id", authorizeRoles(UserRole.INSTRUCTOR), (req, res) => updateCourse(req, res));
