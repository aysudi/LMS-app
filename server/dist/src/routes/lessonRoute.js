...
lessonRouter.post("/", authenticateToken, authorizeRoles(UserRole.INSTRUCTOR), (req, res) => addLesson(req, res));
lessonRouter.put("/:courseId/lesson/:lessonId", authenticateToken, authorizeRoles(UserRole.INSTRUCTOR), (req, res) => updateLesson(req, res));
