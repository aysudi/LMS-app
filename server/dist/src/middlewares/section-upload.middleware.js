...
export const uploadThumbnailToCloudinary = async (buffer, filename) => {
...
export const sectionUploadErrorHandler = (err, req, res, next) => {
...
export const processSectionUploads = async (req, res, next) => {
    try {
        const file = req.file;
        const uploadedFiles = {};
        if (file) {
