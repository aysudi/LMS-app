...
const InstructorInfo: React.FC<{ course: Course }> = ({ course }) => {
  const { t } = useTranslation();
  const instructor = course.instructor as any; // Extended instructor data
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 pt-6 border-t border-gray-200">
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-2xl font-bold text-purple-600">
            {instructor.instructorProfile?.yearsOfExperience || 0}+ years
          </p>
        </div>
        <div className="bg-gray-50 p-4 rounded-lg">
          <h4 className="font-semibold text-gray-900 mb-2">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <h4 className="font-semibold text-gray-900 mb-2">Total Courses</h4>
          <p className="text-2xl font-bold text-green-600">
            {instructor.instructorProfile?.totalCourses || 1}
          </p>
        </div>
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-2xl font-bold text-yellow-600">
            ⭐{" "}
            {instructor.instructorProfile?.averageRating?.toFixed(1) ||
